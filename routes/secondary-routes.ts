...
export const ROUTE_GET_CLIENT_REQUESTS_BY_CLIENT_REQUEST_ID = 'get-client-requests-by-client-request-id'
...
export const ROUTE_GET_CLIENT_HISTORICAL_BY_ADMIN = 'get-client-historical-by-admin'
export const ROUTE_GET_DRIVER_HISTORICAL = 'get-driver-historical'
export const ROUTE_GET_DRIVER_HISTORICAL_BY_ADMIN ='get-driver-historical-by-admin'
...
export const ROUTE_GET_USER_TRANSACTIONS_BY_ADMIN = 'get-user-transactions-by-admin'
export const ROUTE_USER_SEARCH_TRANSACTIONS_DATA_BY_REFERENCE = 'user-search-transactions-data-by-reference'
export const ROUTE_ADMIN_SEARCH_TRANSACTIONS_DATA_BY_REFERENCE = 'admin-search-transactions-data-by-reference'
...
// payment-ride
export const ROUTE_START_PAYMENT_WITH_RAPIDE_WALLET = 'start-payment-with-rapide-wallet'
export const ROUTE_CONFIRM_PAYMENT_WITH_RAPIDE_WALLET = 'confirm-payment-with-rapide-wallet'
...
export const ROUTE_SET_RAPIDE_WALLET_INFORMATION = 'set-rapide-wallet-information'
