...
CREATE TABLE "RideInvoice" (
    ...
    "pickUpLocationPlusCode" TEXT NOT NULL,
    "dropOffLocationPlusCode" TEXT NOT NULL,
...
-- AddForeignKey
ALTER TABLE "ClientProfile" ADD CONSTRAINT "ClientProfile_clientProfileId_fkey" FOREIGN KEY ("clientProfileId") REFERENCES "Profile"("sub") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DriverProfile" ADD CONSTRAINT "DriverProfile_driverProfileId_fkey" FOREIGN KEY ("driverProfileId") REFERENCES "Profile"("sub") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AdminProfile" ADD CONSTRAINT "AdminProfile_adminProfileId_fkey" FOREIGN KEY ("adminProfileId") REFERENCES "Profile"("sub") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "RideInvoice" ADD CONSTRAINT "RideInvoice_clientProfileId_fkey" FOREIGN KEY ("clientProfileId") REFERENCES "ClientProfile"("clientProfileId") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "RideInvoice" ADD CONSTRAINT "RideInvoice_driverProfileId_fkey" FOREIGN KEY ("driverProfileId") REFERENCES "DriverProfile"("driverProfileId") ON DELETE RESTRICT ON UPDATE CASCADE;
